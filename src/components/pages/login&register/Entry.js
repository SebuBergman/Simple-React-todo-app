...
const Login = () => {
  ...
  return (
    <>
      <main>
        <div className={isActive ? 'entrycontainer right-panel-active' : 'entrycontainer'} id="container">
            <div className="form-container register-container">
                <form name="registration_form">
                    ...
                    <button type="submit" onClick={onLoginSubmit}>Register</button>
                </form>
            </div>
            ...
            <div className="form-container login-container">
                <form action="#">
                    ...
                    <button type="submit" onClick={handleRegistration}>Login</button>
                </form>
            </div>
            ...
            <div className="overlay-container">
                <div className="overlay">
                    <div className="overlay-panel overlay-left">
                        ...
                        <button className="ghost" id="login" onClick={handleActive}>Login

                        </button>
                    </div>
                    <div className="overlay-panel overlay-right">
                        <h1 className="title">Start your todo tracking now</h1>
                        <p>if you don't have an account yet, join us and register now</p>
                        <button className="ghost" id="register" onClick={handleActive}>Register
